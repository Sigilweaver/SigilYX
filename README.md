...
The format specification was derived from publicly available open-source YXDB implementations, including Alteryx's own [OpenYXDB](https://github.com/alteryx/OpenYXDB) (MIT License); the implementation itself is original. See [THIRD_PARTY_LICENSES.md](THIRD_PARTY_LICENSES.md) for attribution of vendored components.
