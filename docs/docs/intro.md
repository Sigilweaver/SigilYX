...
sidebar_position: 1
slug: /
description: "High-performance YXDB reader and writer in Rust, with Python bindings for Polars, PyArrow, and Pandas."
---
...
Python bindings (via pyo3-polars) vs the pure-Python `yxdb-py` reader:
